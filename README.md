...
## Main Function
The main function used to adjust pvalue resulting from the search for the optimal fractional polynomial transformation using a resampling method is .github/workflows/Resampling_MFP.R 
### Arguments
